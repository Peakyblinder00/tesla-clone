...
const Navbar = () => {
    ...
    const[rel, setRel] = useState("fixed")
    ...
    useEffect(() => {
        const myFunction = () => {
            ...
            else if(LP.includes("/impact")){
                setPath("none")
            }
            else if (LP.includes("/product")) {
                setPath("none")
            }
            else {
                setPostion(0)
